...
The sample consists of 9,915 observations. To speed up the running time, we will use a 25% subset of the data.
...
Later, smoother matrices can be extracted simply by providing the path to `get_smoother_weights`:

```{r}
S <- get_smoother_weights(
