...
Using some of the most popular prediction functions in R, the `NuisanceParameters` packages estimates nuisance parameters that can be put into practice for causal inference as shown in @knaus.
